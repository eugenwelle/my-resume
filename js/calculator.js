...
const technologiesValue = getTechologiesSum(technologiesMultiSelect.getValue());
...
function getTechologiesSum(technoligiesArr) {
  let totalSum = 0;

  technoligiesArr.forEach( function (tech) {
